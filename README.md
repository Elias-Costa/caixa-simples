...
- **Fila local no PWA** com UUID por gesto, dependências e estados explícitos no IndexedDB. A
  ...
  pertencem à Conta, e só os gestos do usuário atual aparecem sobre eles. Ainda não há envio ao servidor.
...
│   ├── offline/            fila, retratos locais de cadastro e pedido de armazenamento persistente
