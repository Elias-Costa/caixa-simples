...
public interface CaixaParaVenda {
     ...
     * @throws RuntimeException se a sessão não existe nesta conta. A exceção é a do módulo dono e
     *         atravessa sem tradução: um id de outra conta é indistinguível de um id que nunca
     *         existiu (RNF05)
     */
