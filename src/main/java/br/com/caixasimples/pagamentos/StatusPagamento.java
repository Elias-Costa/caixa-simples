 ...
 * para cobrança de Pix gerada por provedor. Dinheiro, cartão e Pix lançados à mão
 ...
 * uma cobrança Pix comprovadamente removida antes do cancelamento da Venda. Erro de digitação não
 * vira RECUSADO: valor recebido menor que a parcela em dinheiro, por exemplo, é recusado na
 * entrada, com exceção, antes de existir resultado nenhum.
 *
